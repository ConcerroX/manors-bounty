...
object ModItems {
    ...
    val BUILDING_ICON_ITEM: DeferredItem<Item> = ITEMS.registerSimpleItem("building_icon_item", Item.Properties())
    ...
    val DURIAN_MILE_CREPE_CAKE_SLICE = registerFoodItem("durian_mile_crepe_cake_slice") {
        DurianFoodItems.Cake(
            it.build(

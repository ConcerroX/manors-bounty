...
object ModRecipeTypes {
    ...
    val ICE_CREAM_MACHINE: DeferredHolder<RecipeType<*>, RecipeType<IceCreamMachineRecipe>> = RECIPE_TYPES.register("ice_cream_machine",
        Supplier { RecipeType.simple(res("ice_cream_machine")) })

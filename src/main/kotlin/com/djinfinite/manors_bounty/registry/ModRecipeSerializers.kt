...
object ModRecipeSerializers {
    ...
    val ICE_CREAM_MACHINE: DeferredHolder<RecipeSerializer<*>, IceCreamMachineRecipe.Serializer> = RECIPE_SERIALIZERS.register(
        "ice_cream_machine", Supplier { IceCreamMachineRecipe.Serializer() })

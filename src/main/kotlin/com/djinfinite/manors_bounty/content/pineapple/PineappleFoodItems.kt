...
object PineappleFoodItems {
    ...
    class Slice(properties: Properties) :
        FoodItem(properties, FoodIngredientType.PINEAPPLE, FoodType.A, ModMobEffects.SUMMER_HEATWAVE, null, 4)

    class Juice(properties: Properties) : FoodItem(
        properties,
        FoodIngredientType.PINEAPPLE,
        FoodType.B,
        ModMobEffects.SUMMER_HEATWAVE,
    ...
    class Pie(properties: Properties) :
        FoodItem(properties, FoodIngredientType.PINEAPPLE, FoodType.C, ModMobEffects.SUMMER_HEATWAVE)

    class Paleteria(properties: Properties) :
        FoodItem(properties, FoodIngredientType.PINEAPPLE, FoodType.C, ModMobEffects.SUMMER_HEATWAVE)

    class Pastries(properties: Properties) :
        FoodItem(properties, FoodIngredientType.PINEAPPLE, FoodType.C, ModMobEffects.SUMMER_HEATWAVE, Items.STICK)

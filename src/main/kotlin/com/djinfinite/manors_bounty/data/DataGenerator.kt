...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, modid = ManorsBounty.MOD_ID)
object DataGenerator {
    ...
    fun gatherData(event: GatherDataEvent) {
        ...
        generator.addProvider(event.includeServer(), ModItemModelProvider(output, existingFileHelper))
    }
